...
OR
What is the idea behind it. Because we already have non-object oriented programming

In this section,
1. Encapsulation: Keeping data & related methods/variables together
2. Abstraction: We are achieving through methods, We just need to know
    how to use methods, No need to know how it is implemented
"""
